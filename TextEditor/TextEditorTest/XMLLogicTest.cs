...
namespace TextEditorTest
{
    ...
    class XMLLogicTest
    {
        ...
        public const string xmlFileConstant =    @"<?xml version=""1.0"" encoding=""ISO-8859-1""?>
                                                <note>
                                                    <to>To</to>
                                                    <from>From</from>
        ...
        public void Init()
        {
            ...
            {
                file.WriteLine(xmlFileConstant); // Write to file
            }
        }
        ...
        public void OpenFile()
        {
            ...
            Assert.AreEqual(xmlContent.Trim(), xmlFileConstant.Trim());
        }
